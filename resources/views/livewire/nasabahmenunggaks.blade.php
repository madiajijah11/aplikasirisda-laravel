    ...
    <div class="py-12">
        <div class="md:container md:mx-auto">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                @endif
                <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Tambah Nasabah</button>
                @if ($isModal)
                @include('livewire.create-nasabahmenunggaks')
                @endif
                <table class="table-fixed border-separate">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="px-4 py-6">Tanggal Jatuh Tempo</th>
                            <th class="px-4 py-6">Jumlah Menunggak</th>
                    ...
                    <tbody>
                        @forelse ($nasabahmenunggaks as $row)
                        <tr>
                            ...
                            <td class="border px-2 py-2">{{ $row->tgljatuhtempo }}</td>
                            <td class="border px-2 py-2">{{ $row->jumlahmenunggak }}</td>
