        ...
        <form>
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="">
              ...
              <div class="mb-4">
                <label for="pinjaman" class="block text-gray-700 text-sm font-bold mb-2">Pinjaman</label>
              ...
              <div class="mb-4">
                <label for="tgljatuhtempo" class="block text-gray-700 text-sm font-bold mb-2">Tanggal Jatuh Tempo</label>
                <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tgljatuhtempo" wire:model="tgljatuhtempo">
                @error('tgljatuhtempo') <span class="text-red-500">{{ $message }}</span>@enderror
              </div>
              <div class="mb-4">
                <label for="jumlahmenunggak" class="block text-gray-700 text-sm font-bold mb-2">Jumlah Menunggak</label>
                <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="jumlahmenunggak" wire:model="jumlahmenunggak">
                @error('jumlahmenunggak') <span class="text-red-500">{{ $message }}</span>@enderror
              </div>
            </div>
          </div>
